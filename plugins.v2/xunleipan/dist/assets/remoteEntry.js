import { _ as __vitePreload } from './vendor-fec5d75f.js';
...
"./Config":()=>{
      ...
      return __federation_import('./__federation_expose_Config-57abbb38.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
