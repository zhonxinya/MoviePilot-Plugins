...
const createVNode = _createVNode$1;
...
class VueElement extends BaseClass {
  constructor(_def, _props = {}, _createApp = createApp$1) {
    ...
    this._ob = null;
    if (this.shadowRoot && _createApp !== createApp$1) {
...
const {normalizeClass:_normalizeClass,normalizeStyle:_normalizeStyle,openBlock:_openBlock,createElementBlock:_createElementBlock} = await importShared('vue');
...
const {createTextVNode:_createTextVNode,resolveDynamicComponent:_resolveDynamicComponent,mergeProps:_mergeProps,withCtx:_withCtx,openBlock:_openBlock2,createBlock:_createBlock} = await importShared('vue');
...
const {createElementVNode:_createElementVNode,openBlock:_openBlock3,createElementBlock:_createElementBlock2} = await importShared('vue');
...
const {toDisplayString:_toDisplayString,createTextVNode:_createTextVNode2,resolveDynamicComponent:_resolveDynamicComponent2,normalizeClass:_normalizeClass2,withCtx:_withCtx2,openBlock:_openBlock7,createBlock:_createBlock2} = await importShared('vue');
...
const {renderList:_renderList,Fragment:_Fragment2,openBlock:_openBlock10,createElementBlock:_createElementBlock7,resolveComponent:_resolveComponent2,mergeProps:_mergeProps3,createBlock:_createBlock5,normalizeClass:_normalizeClass4,withCtx:_withCtx4,createVNode:_createVNode} = await importShared('vue');
...
export { createPropsRestProxy as $, withModifiers as A, BaseTransition as B, BaseTransitionPropsValidators as C, Comment as D, DeprecationTypes as E, ErrorCodes as F, ErrorTypeStrings as G, Fragment as H, Suspense as I, Teleport as J, KeepAlive as K, Text as L, assertNumber as M, callWithAsyncErrorHandling as N, callWithErrorHandling as O, cloneVNode as P, compatUtils as Q, computed as R, Static as S, Transition as T, createBlock as U, VueElement as V, createCommentVNode as W, createElementBlock as X, createBaseVNode as Y, createHydrationRenderer as Z, __vitePreload as _, getSharedFromLocal as a, toHandlers as a$, createRenderer as a0, createSlots as a1, createStaticVNode as a2, createTextVNode as a3, createVNode as a4, defineAsyncComponent as a5, defineComponent$1 as a6, defineEmits as a7, defineExpose as a8, defineModel as a9, onBeforeUpdate as aA, onDeactivated as aB, onErrorCaptured as aC, onMounted as aD, onRenderTracked as aE, onRenderTriggered as aF, onServerPrefetch as aG, onUnmounted as aH, onUpdated as aI, openBlock as aJ, popScopeId as aK, provide$1 as aL, pushScopeId as aM, queuePostFlushCb as aN, registerRuntimeCompiler as aO, renderList as aP, renderSlot as aQ, resolveComponent as aR, resolveDirective as aS, resolveDynamicComponent as aT, resolveFilter as aU, resolveTransitionHooks as aV, setBlockTracking as aW, setDevtoolsHook as aX, setTransitionHooks as aY, ssrContextKey as aZ, ssrUtils as a_, defineOptions as aa, defineProps as ab, defineSlots as ac, devtools as ad, getCurrentInstance$1 as ae, getTransitionRawChildren as af, guardReactiveProps as ag, h as ah, handleError as ai, hasInjectionContext as aj, hydrateOnIdle as ak, hydrateOnInteraction as al, hydrateOnMediaQuery as am, hydrateOnVisible as an, initCustomFormatter as ao, inject$1 as ap, isMemoSame as aq, isRuntimeOnly as ar, isVNode as as, mergeDefaults as at, mergeModels as au, mergeProps as av, nextTick$1 as aw, onActivated as ax, onBeforeMount as ay, onBeforeUnmount as az, TransitionGroup as b, transformVNodeArgs as b0, useAttrs as b1, useId as b2, useModel as b3, useSSRContext as b4, useSlots as b5, useTemplateRef as b6, useTransitionState as b7, version as b8, warn as b9, onWatcherCleanup as bA, proxyRefs as bB, reactive as bC, readonly as bD, ref as bE, shallowReactive as bF, shallowReadonly as bG, shallowRef as bH, stop as bI, toRaw$1 as bJ, toRef as bK, toRefs as bL, toValue as bM, triggerRef as bN, unref$1 as bO, camelize as bP, capitalize as bQ, normalizeClass as bR, normalizeProps as bS, normalizeStyle as bT, toDisplayString as bU, toHandlerKey as bV, watch as ba, watchEffect as bb, watchPostEffect as bc, watchSyncEffect as bd, withAsyncContext as be, withCtx as bf, withDefaults as bg, withDirectives as bh, withMemo as bi, withScopeId as bj, EffectScope as bk, ReactiveEffect as bl, TrackOpTypes as bm, TriggerOpTypes as bn, customRef as bo, effect as bp, effectScope as bq, getCurrentScope as br, getCurrentWatcher as bs, isProxy as bt, isReactive as bu, isReadonly as bv, isRef as bw, isShallow as bx, markRaw as by, onScopeDispose as bz, compile as c, createApp$1 as d, createSSRApp as e, defineCustomElement as f, getSharedFromRuntime as g, defineSSRCustomElement as h, importShared as i, hydrate as j, initDirectivesForSSR as k, useCssModule as l, useCssVars as m, nodeOps as n, useHost as o, patchProp as p, useShadowRoot as q, render$1 as r, vModelDynamic as s, vModelRadio as t, useToast as u, vModelCheckbox as v, vModelSelect as w, vModelText as x, vShow as y, withKeys as z };
